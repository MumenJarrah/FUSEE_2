...
int main(int argc, char **argv) {
    ...
    // Write CAS stats next to throughput file
    {
        ...
        cas_out << "attempted_ops,success_ops,failed_ops,failed_reads_no_match,failed_writes_pre_cas,failed_cas,retry_cas,failed_ops_due_to_cas,update_cas_soft_fail,primary_cas_success,primary_cas_cmp_fail,backup_cas_success,backup_cas_cmp_fail\n";
        cas_out << attempted_ops << "," << success_ops << "," << failed_ops << ","
                ...
                << client.stat_primary_cas_success_ << "," << client.stat_primary_cas_cmp_fail_ << ","
                << client.stat_backup_cas_success_ << "," << client.stat_backup_cas_cmp_fail_ << "\n";
    }
